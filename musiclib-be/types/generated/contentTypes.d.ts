...
export interface ApiFavoriteAlbumFavoriteAlbum
  extends Struct.CollectionTypeSchema {
  collectionName: 'favorite_albums';
  info: {
    displayName: 'favorite-album';
    pluralName: 'favorite-albums';
    singularName: 'favorite-album';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    exId: Schema.Attribute.String;
    image: Schema.Attribute.String;
    listeners: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    playcount: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    menu: Schema.Attribute.Component<'shared.navbar-links', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    favorite_albums: Schema.Attribute.Relation<
      'oneToMany',
      'api::favorite-album.favorite-album'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::favorite-album.favorite-album': ApiFavoriteAlbumFavoriteAlbum;
